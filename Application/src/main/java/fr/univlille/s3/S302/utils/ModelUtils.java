...
public class ModelUtils {
    /**
     * Renvoie le pourcentage le plus haut parmis les plus proches voisins et
     * choisissant le nombre de voisin le plus aproprier
     * 
    ...
    /**
     * Renvoie la catégorie la plus prés,ete dans la liste de données en parametre
     * et si il y a une égalité, la première rencontrée
     * 
     * @param listeData la liste de données
